...
public abstract class AbstractOpenSearchOperations<F extends AbstractOpenSearchOperations> implements
     ...
     * @param count int
     * @return F
     * @see org.springframework.social.nk.api.impl.CommonOpenSocialOperations#setCount(int)
     */
     ...
     * @return F
     * @see org.springframework.social.nk.api.impl.CommonOpenSocialOperations#setStartIndex(int)
     */
    @SuppressWarnings("unchecked")
    @Override
